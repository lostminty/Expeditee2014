...
public class BrowserApplet extends JApplet implements ActionListener
{
	...
	String java_args = this.getParameter("java_arguments"); 
	String testarg = this.getParameter("testarg"); 
...
*/
	...
	JButton launch_button = new JButton("Launch Expeditee  ... : " + java_args + ", " + testarg);
